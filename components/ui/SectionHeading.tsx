...
export const SectionHeading: React.FC<SectionHeadingProps> = ({
  ...
  return (
    <div className={cn("flex flex-col mb-12 md:mb-16 max-w-3xl", alignmentStyles[align], className)}>
      ...
      {subheading && (
        <p className="text-base md:text-lg text-ink-muted leading-relaxed font-sans max-w-2xl">
          {subheading}
        </p>
      )}
    </div>
