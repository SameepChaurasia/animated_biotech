  ...
  return (
    <section id="playground" className="py-4 md:py-5 lg:py-6 bg-transparent relative overflow-hidden select-none">
      <Container className="relative z-10 max-w-6xl">
        ...
        {/* ══════════════════════════════════════════════════════════════════
            UNIFIED STUDIO INSTRUMENT PANEL (Elevated 3D Sci-Fi Bio-Chassis)
           ══════════════════════════════════════════════════════════════════ */}
        <div className="relative group/workbench isolate">
          {/* Ambient 3D High Drop & Ground Shadow Backplate */}
          <div className="absolute inset-x-8 -bottom-7 h-16 bg-black/95 blur-2xl rounded-full pointer-events-none -z-20 transform-gpu" />
          <div className="absolute -inset-1.5 rounded-3xl bg-gradient-to-r from-cyan-500/25 via-indigo-500/20 to-purple-500/25 blur-xl opacity-75 group-hover:opacity-100 transition-all duration-700 pointer-events-none -z-10" />

          {/* Outer Multi-tone 3D Bezel Chassis */}
          <div className="relative p-[1.5px] rounded-2xl md:rounded-[22px] bg-gradient-to-b from-cyan-400/60 via-slate-700/50 to-purple-500/50 shadow-[0_25px_70px_-15px_rgba(0,0,0,0.95),0_0_40px_-5px_rgba(6,182,212,0.25),0_0_80px_-15px_rgba(99,102,241,0.2),inset_0_1px_1px_rgba(255,255,255,0.3)] transition-all duration-500 hover:shadow-[0_35px_85px_-15px_rgba(0,0,0,0.98),0_0_55px_rgba(6,182,212,0.35),0_0_90px_rgba(99,102,241,0.3)]">
            
            {/* Precision 3D Corner Hardware Brackets & Sci-Fi Reticles */}
            {/* Top-Left Corner */}
            <div className="absolute -top-1.5 -left-1.5 w-6 h-6 pointer-events-none z-20">
              <div className="w-full h-full border-t-2 border-l-2 border-cyan-400 rounded-tl-xl shadow-[0_0_10px_#22d3ee]" />
              <div className="absolute top-1.5 left-1.5 w-1.5 h-1.5 rounded-full bg-cyan-400 shadow-[0_0_8px_#22d3ee] animate-pulse" />
            </div>

            {/* Top-Right Corner */}
            <div className="absolute -top-1.5 -right-1.5 w-6 h-6 pointer-events-none z-20">
              <div className="w-full h-full border-t-2 border-r-2 border-cyan-400 rounded-tr-xl shadow-[0_0_10px_#22d3ee]" />
              <div className="absolute top-1.5 right-1.5 w-1.5 h-1.5 rounded-full bg-cyan-400 shadow-[0_0_8px_#22d3ee] animate-pulse" />
            </div>

            {/* Bottom-Left Corner */}
            <div className="absolute -bottom-1.5 -left-1.5 w-6 h-6 pointer-events-none z-20">
              <div className="w-full h-full border-b-2 border-l-2 border-purple-400 rounded-bl-xl shadow-[0_0_10px_#c084fc]" />
              <div className="absolute bottom-1.5 left-1.5 w-1.5 h-1.5 rounded-full bg-purple-400 shadow-[0_0_8px_#c084fc]" />
            </div>

            {/* Bottom-Right Corner */}
            <div className="absolute -bottom-1.5 -right-1.5 w-6 h-6 pointer-events-none z-20">
              <div className="w-full h-full border-b-2 border-r-2 border-purple-400 rounded-br-xl shadow-[0_0_10px_#c084fc]" />
              <div className="absolute bottom-1.5 right-1.5 w-1.5 h-1.5 rounded-full bg-purple-400 shadow-[0_0_8px_#c084fc]" />
            </div>

            {/* Top Edge Specular Ray */}
            <div className="absolute top-0 inset-x-8 h-[1.5px] bg-gradient-to-r from-transparent via-cyan-400/80 to-transparent shadow-[0_0_10px_#22d3ee] z-20 pointer-events-none" />

            {/* Main Instrument Body Panel */}
            <div className="rounded-[calc(1rem+4px)] md:rounded-[20px] bg-slate-950/90 backdrop-blur-2xl overflow-hidden relative border border-slate-800/80 shadow-[inset_0_1px_2px_rgba(255,255,255,0.12),inset_0_-2px_6px_rgba(0,0,0,0.8)]">
              ...
              {/* ─────────────────────────────────────────────────────────────
                 ...
                 ───────────────────────────────────────────────────────────── */}
              <div className="py-2.5 px-3 sm:px-4 border-b border-slate-800/80 bg-slate-900/50 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
              ...
              <div className="p-3 sm:p-4 space-y-3">
                ...
                <div className="p-3 sm:p-3.5 rounded-xl bg-slate-950/85 border border-slate-800/90 shadow-[inset_0_2px_6px_rgba(0,0,0,0.7),0_1px_0_rgba(255,255,255,0.06)] relative backdrop-blur-sm">
                ...
                <div className="p-3 sm:p-3.5 rounded-xl bg-slate-950/85 border border-slate-800/90 shadow-[inset_0_2px_6px_rgba(0,0,0,0.7),0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-sm">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-1.5">
              ...
              <div className="p-3 sm:p-4 border-t border-slate-800/80 bg-slate-900/60 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-2.5">
                ...
                <div className="col-span-2 sm:col-span-3 lg:col-span-1 p-2.5 rounded-xl bg-slate-950/90 border border-slate-800/90 hover:border-cyan-500/50 shadow-[0_4px_12px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.06)] hover:shadow-[0_8px_20px_-4px_rgba(6,182,212,0.3)] hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between">
                  <div>
                ...
                <div className="p-2.5 rounded-xl bg-slate-950/90 border border-slate-800/90 hover:border-cyan-500/50 shadow-[0_4px_12px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.06)] hover:shadow-[0_8px_20px_-4px_rgba(6,182,212,0.3)] hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between">
                ...
                <div className="p-2.5 rounded-xl bg-slate-950/90 border border-slate-800/90 hover:border-sky-500/50 shadow-[0_4px_12px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.06)] hover:shadow-[0_8px_20px_-4px_rgba(56,189,248,0.3)] hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between">
                  <span className="text-[8px] font-mono text-slate-400 uppercase tracking-wider block">
                    MELTING TEMP (Tm)
                  </span>
                  <div className="my-0.5">
                ...
                <div className="p-2.5 rounded-xl bg-slate-950/90 border border-slate-800/90 hover:border-purple-500/50 shadow-[0_4px_12px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.06)] hover:shadow-[0_8px_20px_-4px_rgba(168,85,247,0.3)] hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between">
                  <span className="text-[8px] font-mono text-slate-400 uppercase tracking-wider block">
                    FREE ENERGY (ΔG)
                  </span>
                  <div className="my-0.5">
                ...
                <div className="p-2.5 rounded-xl bg-slate-950/90 border border-slate-800/90 hover:border-emerald-500/50 shadow-[0_4px_12px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.06)] hover:shadow-[0_8px_20px_-4px_rgba(16,185,129,0.3)] hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between">
                  <span className="text-[8px] font-mono text-slate-400 uppercase tracking-wider block">
                    AFFINITY (Kd)*
                  </span>
                  <div className="my-0.5">
